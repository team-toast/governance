...
class App extends Component {
    ...
    levrGlevrMod = (levrMod, gLevrMod) => {
        let tmpLevr = this.state.levrBalance.replace(/,/g, "");
        let tmpGlevr = this.state.balance.replace(/,/g, "");
        let tmpVP = this.state.votingPower.replace(/,/g, "");
        let tmpTS = this.state.totalSupply;

        this.setState({
            levrBalance: this.numberWithCommas(
                (parseFloat(tmpLevr) + parseFloat(levrMod)).toString()
            ),
            balance: this.numberWithCommas(
                (parseFloat(tmpGlevr) + parseFloat(gLevrMod)).toString()
            ),
        });
                        ...
                        {this.state.page === "page__proposals" && (
                            <div id="page__proposals">
                                ...
                                <Header
                                    ...
                                    levrGlevrMod={this.levrGlevrMod}
                                    onConnect={this.onConnect}
